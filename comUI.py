...
class Compute():
    ...
    def buttonCompute(self):
        self.in_entry = tkinter.Label(self.win, bd=3,bg='#FCF4F0', font=("宋体", 30), textvariable=self.show)
        ...
        button1 = tkinter.Button(self.win, bg='#C8CDFF', text='%', command=lambda: (self.symbol_1()))
        button1.place(x=185, y=110, width=70, height=50)
        button2 = tkinter.Button(self.win, bg='#C8CDFF', text='/', command=lambda: (self.symbol_2()))
        button2.place(x=270, y=110, width=70, height=50)

        button3 = tkinter.Button(self.win, bg='#FCF4F0', text='7', command=lambda: (self.seven()))
        button3.place(x=15, y=170, width=70, height=50)
        button4 = tkinter.Button(self.win, bg='#FCF4F0', text='8', command=lambda: (self.eight()))
        button4.place(x=100, y=170, width=70, height=50)
        button5 = tkinter.Button(self.win, bg='#FCF4F0', text='9', command=lambda: (self.nine()))
        button5.place(x=185, y=170, width=70, height=50)
        button6 = tkinter.Button(self.win, bg='#C8CDFF', text='*', command=lambda: (self.symbol_3()))
        button6.place(x=270, y=170, width=70, height=50)

        button7 = tkinter.Button(self.win, bg='#FCF4F0', text='4', command=lambda: (self.four()))
        button7.place(x=15, y=230, width=70, height=50)
        button8 = tkinter.Button(self.win, bg='#FCF4F0', text='5', command=lambda: (self.five()))
        button8.place(x=100, y=230, width=70, height=50)
        button9 = tkinter.Button(self.win, bg='#FCF4F0', text='6', command=lambda: (self.six()))
        button9.place(x=185, y=230, width=70, height=50)
        button10 = tkinter.Button(self.win, bg='#C8CDFF', text='-', command=lambda: (self.symbol_4()))
        button10.place(x=270, y=230, width=70, height=50)

        button11 = tkinter.Button(self.win, bg='#FCF4F0', text='1', command=lambda: (self.one()))
        button11.place(x=15, y=290, width=70, height=50)
        button12 = tkinter.Button(self.win, bg='#FCF4F0', text='2', command=lambda: (self.two()))
        button12.place(x=100, y=290, width=70, height=50)
        button13 = tkinter.Button(self.win, bg='#FCF4F0', text='3', command=lambda: (self.three()))
        button13.place(x=185, y=290, width=70, height=50)
        button14 = tkinter.Button(self.win, bg='#C8CDFF', text='+', command=lambda: (self.symbol_5()))
        button14.place(x=270, y=290, width=70, height=50)

        #button15 = tkinter.Button(self.win, bg='gray', text=' ')
        #button15.place(x=15, y=210, width=70, height=30)
        button16 = tkinter.Button(self.win, bg='#FCF4F0', text='0', command=lambda: (self.zero()))
        button16.place(x=15, y=350, width=155, height=50)
        button17 = tkinter.Button(self.win, bg='#C8CDFF', text='.', command=lambda: (self.symbol_6()))
        button17.place(x=185, y=350, width=70, height=50)
        button18 = tkinter.Button(self.win, bg='#5B7FA7', text='=', command=lambda: (self.result()))
